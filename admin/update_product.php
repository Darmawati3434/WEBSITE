...
<section class="update-product">
   ...
   <form action="" method="POST" enctype="multipart/form-data">
      ...
      <select name="category" class="box" required>
         ...
         <option value="Nugget Roti">Kopi Espresso Late</option>
         <option value="Kopi Seduh">Kue coklat</option>
         <option value="Kopi Bubuk">Kopi Coklat putih</option>
         <option value="Kopi Bubuk">Sandwich Sayuran</option>
      </select>
